...
class TestWin(QWidget):
   def __init__(self):
       ...
       # cmembuat dan mengkonfigurasi elemen grafis:
       self.initUI()
   ...
   def initUI(self):
       ...
       self.btn_test1.setFont(QFont('Times', 15))
       self.btn_test2 = QPushButton(txt_starttest2, self)
       self.btn_test2.setFont(QFont('Times', 15))
       self.btn_test3 = QPushButton(txt_starttest3, self)
       self.btn_test3.setFont(QFont('Times', 15))


       self.text_name = QLabel(txt_name)
       self.text_name.setFont(QFont('Times', 10))
       self.text_age = QLabel(txt_age)
       self.text_age.setFont(QFont('Times', 10))
       self.text_test1 = QLabel(txt_test1)
       self.text_test1.setFont(QFont('Times', 10))
       self.text_test2 = QLabel(txt_test2)
       self.text_test2.setFont(QFont('Times', 10))
       self.text_test3 = QLabel(txt_test3)
       self.text_test3.setFont(QFont('Times', 10))
